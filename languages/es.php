...
$mapping = array(
	...
	'advpoll:editare' => 'Editor de votaciones',
	...
	'advpoll:votar:opcion' => 'Elige la opción que prefieras',
	'advpoll:respuesta' => 'Opción',
	'advpoll:debate:previo:link' => 'Enlace al debate previo',
	'advpoll:advertencia:editar' => 'Por motivos de seguridad no se pueden modificar las opciones de una votación una vez creada',
	'advpoll:pregunta' => 'Título de la pregunta',
	'advpoll:advertencia:editar:titulo' => 'Por motivos de seguridad no se puede modificar la pregunta de la votación una vez creada',
	'advpoll:advertencia:editar:auditoria' => 'Por motivos de privacidad no se puede modificar esta opción una vez creada la votación',
	'advpoll:filtros:encurso' => 'En Curso',
	'advpoll:filtros:finalizadas' => 'Finalizadas',
	'advpoll:filtros:totus' => 'Todas',
	'advpoll:filtros:amigos' => 'De Amigos',
	'advpoll:filtros:trujaman' => 'Mías',
	'advpoll:filtros:noiniciadas' => 'No Iniciadas',
	...
	'advpoll:condorcet:votar:opcion' => 'Ordena las opciones según tus preferencias y pulsa el botón "votar"',
	...
	'advpoll:fecha:inicio' => 'La votación comienza el día ',
	'advpoll:fecha:fin' => ' y termina el día ',
	'advpoll:fecha:ayuda' => 'Dejar en blanco para controlar la votación de manera manual',
	'advpoll:acceso:ver' => '¿Quién puede ver los resultados de la votación?',
	'advpoll:acceso:votar' => '¿Quién puede votar?',
	'advpoll:vistazo:tiempo:desde' => ' Periodo de votación desde el ',
	'advpoll:vistazo:tiempo:hasta' => ' hasta el ',
	'advpoll:vistazo:finalizada:si' => 'Finalizada',
	'advpoll:vistazo:finalizada:no' => 'Activa',
	'advpoll:vistazo:finalizada:menorfin:menorini' => 'No iniciada',
	'advpoll:vistazo:finalizada:menorfin:mayorini' => 'Activa',
	'advpoll:vistazo:finalizada:mayorfin:menorini' => 'Imposible',
	'advpoll:vistazo:finalizada:mayorfin:mayorini' => 'Finalizada',
	...
	'advpoll:advertencia:editar:mostrar:resultados' => 'Por cuestiones de privacidad no se permite modificar este parámetro una vez creada la votación',
